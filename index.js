...
denz.sendMessage(mdata.id, buttonMessages, MessageType.buttonsMessage, {
        ...
        caption: 'Tes',
            quoted: fkontakk})
            //sendButLocation(mdata.id, `${masuk}`, `${uwu}𝙱 𝚁 𝙸 𝚃 𝙾 右${uwu}`, {jpegThumbnail:buff}, [{buttonId:`Zmenu`,buttonText:{displayText:'HALLO'},type:1}], {contextInfo: { mentionedJid: [num]}})
...
fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6283136505591-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;Denz;;;\nFN:Denz\nitem1.TEL;waid=91735637894:919567941560\nitem1.X-ABLabel:𝙸𝚗𝚍𝚒𝚊\nEND:VCARD` }}}
num = anu.participants[0]
...
♧︎︎︎ \`\`\`𝚃𝚈𝙿𝙴 : ${c3type}\`\`\`
♧︎︎︎ \`\`\`𝙱𝙾𝚃 𝙱𝚈 - ʙʀɪᴛᴛᴏ_sɪʀ\`\`\``, MessageType.text, {quoted: m.message, contextInfo: {"mentionedJid": [m.participant]}})
}
})
}
