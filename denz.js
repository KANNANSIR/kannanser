...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: '𝙾𝙽𝙻𝚈 𝙵𝙾𝚁 ✰ʙʀɪᴛᴛᴏᴥ︎︎︎sɪʀ♕︎✔︎',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© *_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'ʜɪ ʙʀᴏ....👋', "groupName": `${NamaBot}`, "footerText": "*_© _*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© *_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `*_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/919633687665?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
fill =`༄ʜɪ ʙʀᴏ... ${pushname}, ${tampilUcapan}
sᴇʟᴇᴄᴛ ᴍᴇɴᴜ☟︎︎︎..

If the button doesnt appear, type .allmenu
`
menu =`✰ɪᴛsᴍᴇ ᴥ︎︎︎ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩`
gbutsan = [
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "*_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
├𖨆 *_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'🐦OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
 stod = `${sender}`
 listMsg = {
 buttonText: '𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄⁩',
 footerText: '*_© *_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*_*',
 description: `ʜɪ ʙʀᴏ @${stod.split('@')[0]}, 𝚃𝙷𝙸𝚂 𝙸𝚂 𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄`,
 sections: [
                     {
                      "title": `*_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*`,
 rows: [
                          {
                              "title": "Script",
                              "rowId": ""
...
break
		...
		case 'sourcecode':
		anu =`╭─❒ SCRIPT
│➩➬𝙱𝙰𝚂𝙴 : *_© ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩_*
│➩➬𝙴𝚁𝚁𝙾𝚁 𝙲𝙷𝙴𝙲𝙺𝙸𝙽𝙶 : *ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩*
│
└──────[ 𝚂𝙲𝚁𝙸𝙿𝚃 ]──────❒
  │➬➩ : 𝙽𝙾𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝚈𝙴𝚃
  └──────────────────❒`
...
break
            ...
            break
				case 'chat':
			if (args[0].startsWith('08')) return reply('Prefix number with 919633687665')
            if (args[0].startsWith('+62')) return reply('Prefix number with 919633687665')
			if (args.length < 1) return reply(`Use ${prefix}chat 919633687665xxxx|text`)
            var pc = body.slice(6)
    	   ...
    	   break
				case 'tag':
			if (args.length < 1) return reply(`Use ${prefix}tag 919633687665*****o`)
...
🏵️𝙶𝚁𝙾𝚄𝙿 𝙲𝙷𝙰𝚃 : ${groups.length}
🌺𝚃𝙾𝚃𝙰𝙻 𝙲𝙷𝙰𝚃 : ${totalChat.length}
🏵️𝚂𝙿𝙴𝙴𝙳 : ${latensi.toFixed(4)} second
🌺𝚁𝚄𝙽𝚃𝙸𝙼𝙴 : ${kyun(uptime)}
🏵️𝙱𝙰𝚃𝚃𝙰𝚁𝚈 : ${baterai.battery}
🌺𝙲𝙷𝙰𝚁𝙶𝙴𝙳 : ${baterai.isCharge}
🏵️𝙼𝙾𝙳𝙴 : ${publik ? 'public' : 'self'}
🌺𝙿𝚁𝙴𝙵𝙸𝚇 : ${multi ? 'Multi Prefix' : 'No Prefix'}
🏵️𝚄𝚂𝙰𝙶𝙴 𝙾𝙵 𝚁𝙰𝙼 : ${ram2}
🌺𝙷𝙾𝚂𝚃𝙽𝙰𝙼𝙴 : ${os.hostname()}
🏵️𝙿𝙻𝙰𝚃𝙵𝙾𝚁𝙼 : ${os.platform()}
🌺𝚄𝙿𝚃𝙸𝙼𝙴 : ${kyun(os.uptime())}
🏵️𝙼𝙽𝙲 : ${mnc}
🌺𝙼𝙲𝚅 : ${mcc}
🏵️𝙳𝙴𝚅𝙸𝙲𝙴 𝙼𝙾𝙳𝙴𝙻 : ${denz.user.phone.device_model}
🌺𝙳𝙴𝚅𝙸𝙲𝙴 𝙼𝙰𝙽𝚄𝙵𝙰𝙲𝚃𝚄𝚁 : ${device_manufacturer}
🏵️𝚆𝙰 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: ${denz.user.phone.wa_version}
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ꪶ 𝑲𝑹𝑰𝒁⇥𝑺𝑬𝑹ꫂ⁩",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/919633687665?text=Hi Bro"}}})
	}
    }
    }
    }
